...
const FlowGridLogo = ({ size = 36 }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
    <defs>
      <linearGradient id="flowgridLogoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#3B82F6" />
        <stop offset="100%" stopColor="#8B5CF6" />
      </linearGradient>
    </defs>
    <rect x="4" y="6" width="10" height="4" rx="1" fill="url(#flowgridLogoGradient)" opacity="0.85"/>
    <rect x="4" y="13" width="24" height="5" rx="1.5" fill="url(#flowgridLogoGradient)"/>
    <rect x="4" y="21" width="18" height="4" rx="1" fill="url(#flowgridLogoGradient)" opacity="0.7"/>

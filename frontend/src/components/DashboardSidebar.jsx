...
const items = [
  { key: 'home', label: 'Dashboard', icon: 'chart' },
  { key: 'builder', label: 'Strategy Builder', icon: 'puzzle' },
  { key: 'backtest', label: 'Backtesting Suite', icon: 'bolt' },
  { key: 'analytics', label: 'Analytics & Insights', icon: 'ai' },
  { key: 'alerts', label: 'Alerts & Notifications', icon: 'drop' },
  { key: 'account', label: 'Account & Settings', icon: 'key' },
  { key: 'billing', label: 'Billing / Subscription', icon: 'target' },
    ...
    <div className="df-sidebar">
      <div className="df-logo">
        <div style={{display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8}}>
          ...
          <h2 style={{fontSize: 16, fontWeight: 700, color: 'rgb(248,249,250)', margin: 0}}>FLOWTRADE</h2>
        </div>
      </div>

...
const strategyTemplates = {
  ...
  'momentum-trading': {
    ...
    nodes: [
      ...
      { id: 3, type: 'volume_spike', x: 280, y: 280, title: 'Volume Filter', configValues: { period: 20, multiplier: 1.5, signalMode: 'spike_detected', signalDirection: 'bullish' } },
      { id: 4, type: 'ema', x: 280, y: 80, title: 'Fast EMA (9)', configValues: { period: 9, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 5, type: 'ema', x: 280, y: 160, title: 'Slow EMA (20)', configValues: { period: 20, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
  ...
  'scalping': {
    ...
    nodes: [
      ...
      { id: 3, type: 'vwap', x: 280, y: 180, title: 'VWAP', configValues: { output: 'signal', condition: 'near', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 4, type: 'rsi', x: 280, y: 300, title: 'RSI Momentum', configValues: { period: 7, source: 'close', overbought: 70, oversold: 30, signalMode: 'oversold_buy', signalDirection: 'bullish' } },
  ...
  'breakout': {
    ...
    nodes: [
      ...
      { id: 3, type: 'bollinger', x: 280, y: 80, title: 'BB Upper', configValues: { period: 20, num_std: 2, source: 'close', output: 'upper', signalMode: 'price_above_upper', signalDirection: 'bullish' } },
      { id: 4, type: 'bollinger', x: 280, y: 180, title: 'BB Lower', configValues: { period: 20, num_std: 2, source: 'close', output: 'lower', signalMode: 'price_below_lower', signalDirection: 'bullish' } },
      { id: 5, type: 'volume_spike', x: 280, y: 300, title: 'Volume Spike', configValues: { period: 20, multiplier: 1.5, signalMode: 'spike_detected', signalDirection: 'bullish' } },
  ...
  'range-trading': {
    ...
    nodes: [
      ...
      { id: 2, type: 'bollinger', x: 280, y: 80, title: 'BB Upper (Resistance)', configValues: { period: 20, num_std: 2, source: 'close', output: 'upper', signalMode: 'price_above_upper', signalDirection: 'bearish' } },
      { id: 3, type: 'bollinger', x: 280, y: 180, title: 'BB Lower (Support)', configValues: { period: 20, num_std: 2, source: 'close', output: 'lower', signalMode: 'price_below_lower', signalDirection: 'bullish' } },
      { id: 4, type: 'rsi', x: 280, y: 300, title: 'RSI', configValues: { period: 14, source: 'close', overbought: 70, oversold: 30, signalMode: 'overbought_sell', signalDirection: 'bearish' } },
  ...
  'pullback': {
    ...
    nodes: [
      { id: 1, type: 'input', x: 80, y: 150, title: 'Price Input', configValues: { symbol: 'SPY', timeframe: '5Min', days: 1 } },
      { id: 2, type: 'ema', x: 280, y: 80, title: 'Fast EMA (9)', configValues: { period: 9, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 3, type: 'ema', x: 280, y: 180, title: 'Slow EMA (20)', configValues: { period: 20, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 4, type: 'ema', x: 280, y: 280, title: 'Trend EMA (50)', configValues: { period: 50, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
  ...
  'vwap-reversion': {
    ...
    nodes: [
      ...
      { id: 2, type: 'volume_history', x: 80, y: 300, title: 'Volume Data', configValues: {} },
      { id: 3, type: 'vwap', x: 280, y: 200, title: 'VWAP', configValues: { output: 'value', signalMode: 'price_below', signalDirection: 'bullish' } },
      { id: 4, type: 'atr', x: 280, y: 320, title: 'ATR (Extension)', configValues: { period: 14, source: 'close' } },
      { id: 5, type: 'rsi', x: 480, y: 100, title: 'RSI Extreme', configValues: { period: 7, source: 'close', overbought: 80, oversold: 20, signalMode: 'oversold_or_overbought', signalDirection: 'bullish' } },
  ...
  'reversal': {
    ...
    nodes: [
      { id: 1, type: 'input', x: 80, y: 150, title: 'Price Input', configValues: { symbol: 'SPY', timeframe: '5Min', days: 1 } },
      { id: 2, type: 'volume_history', x: 80, y: 300, title: 'Volume Data', configValues: {} },
      { id: 3, type: 'rsi', x: 280, y: 100, title: 'RSI Extreme', configValues: { period: 14, source: 'close', overbought: 80, oversold: 20, signalMode: 'oversold_or_overbought', signalDirection: 'bullish' } },
      { id: 4, type: 'volume_spike', x: 280, y: 300, title: 'Exhaustion Volume', configValues: { period: 20, multiplier: 2.5, signalMode: 'spike_detected', signalDirection: 'bullish' } },
      { id: 5, type: 'stochastic', x: 280, y: 420, title: 'Stochastic Cross', configValues: { period: 14, smooth_k: 3, smooth_d: 3, source: 'close', overbought: 80, oversold: 20, signalMode: 'oversold_or_overbought', signalDirection: 'bullish' } },
  ...
  'gap-and-go': {
    ...
    nodes: [
      { id: 1, type: 'input', x: 80, y: 150, title: 'Price Input', configValues: { symbol: 'SPY', timeframe: '1Min', days: 1 } },
      { id: 2, type: 'volume_history', x: 80, y: 300, title: 'Volume Data', configValues: {} },
      { id: 3, type: 'volume_spike', x: 280, y: 300, title: 'High Volume', configValues: { period: 20, multiplier: 2.0, signalMode: 'spike_detected', signalDirection: 'bullish' } },
      { id: 4, type: 'vwap', x: 280, y: 150, title: 'VWAP', configValues: { output: 'signal', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 5, type: 'ema', x: 480, y: 80, title: 'Fast EMA (9)', configValues: { period: 9, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
  ...
  'news-momentum': {
    ...
    nodes: [
      { id: 1, type: 'input', x: 80, y: 150, title: 'Price Input', configValues: { symbol: 'SPY', timeframe: '1Min', days: 1 } },
      { id: 2, type: 'volume_history', x: 80, y: 300, title: 'Volume Data', configValues: {} },
      { id: 3, type: 'volume_spike', x: 280, y: 300, title: 'Volume Surge', configValues: { period: 20, multiplier: 3.0, signalMode: 'spike_detected', signalDirection: 'bullish' } },
      { id: 4, type: 'macd', x: 280, y: 150, title: 'MACD Momentum', configValues: { fast: 12, slow: 26, signal: 9, source: 'close', output: 'histogram', signalMode: 'histogram_positive', signalDirection: 'bullish' } },
  ...
  'intraday-trend': {
    ...
    nodes: [
      ...
      { id: 2, type: 'ema', x: 280, y: 80, title: 'EMA 20', configValues: { period: 20, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 3, type: 'ema', x: 280, y: 180, title: 'EMA 50', configValues: { period: 50, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
      { id: 4, type: 'macd', x: 280, y: 300, title: 'MACD', configValues: { fast: 12, slow: 26, signal: 9, source: 'close', output: 'histogram', signalMode: 'histogram_positive', signalDirection: 'bullish' } },
  ...
  'rsi-divergence': {
    ...
    nodes: [
      { id: 1, type: 'input', x: 80, y: 150, title: 'Price Input', configValues: { symbol: 'SPY', timeframe: '5Min', days: 2 } },
      { id: 2, type: 'rsi', x: 280, y: 120, title: 'RSI', configValues: { period: 14, source: 'close', overbought: 70, oversold: 30, signalMode: 'oversold_or_overbought', signalDirection: 'bullish' } },
      { id: 3, type: 'stochastic', x: 280, y: 260, title: 'Stochastic', configValues: { period: 14, smooth_k: 3, smooth_d: 3, source: 'close', overbought: 80, oversold: 20, signalMode: 'oversold_or_overbought', signalDirection: 'bullish' } },
      { id: 4, type: 'macd', x: 480, y: 80, title: 'MACD Confirm', configValues: { fast: 12, slow: 26, signal: 9, source: 'close', output: 'histogram', signalMode: 'histogram_positive', signalDirection: 'bullish' } },
  ...
  'macd-crossover': {
    ...
    nodes: [
      { id: 1, type: 'input', x: 80, y: 150, title: 'Price Input', configValues: { symbol: 'SPY', timeframe: '5Min', days: 2 } },
      { id: 2, type: 'macd', x: 280, y: 100, title: 'MACD Line', configValues: { fast: 12, slow: 26, signal: 9, source: 'close', output: 'macd', signalMode: 'line_above_signal', signalDirection: 'bullish' } },
      { id: 3, type: 'macd', x: 280, y: 220, title: 'Signal Line', configValues: { fast: 12, slow: 26, signal: 9, source: 'close', output: 'signal', signalMode: 'line_above_signal', signalDirection: 'bullish' } },
      { id: 4, type: 'ema', x: 280, y: 340, title: 'Trend Filter (EMA 50)', configValues: { period: 50, source: 'close', output: 'value', signalMode: 'price_above', signalDirection: 'bullish' } },
